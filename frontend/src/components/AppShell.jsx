...
export default function AppShell({ children }) {
  ...
  return (
    <div className="min-h-screen bg-page text-black flex relative">
      ...
      <aside
        className="hidden lg:flex flex-col w-64 border-r border-ash/25 py-8 sticky top-0 h-screen z-10"
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <main className="flex-1 pt-[4.75rem] lg:pt-0 overflow-x-hidden relative z-10">
