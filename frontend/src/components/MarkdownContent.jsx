...
export default function MarkdownContent({ content, className = '' }) {
  ...
  const components = useMemo(
    () => ({
      ...
      p: ({ children }) => (
        <p className="text-charcoal text-[15px] leading-[1.8] mb-3.5 last:mb-0 break-words">
          {children}
        </p>
      ),
      strong: ({ children }) => (
      ...
      li: ({ children }) => (
        <li className="pl-1 break-words [&>p]:mb-1 [&>p]:leading-[1.75] [&>ul]:mt-2 [&>ol]:mt-2 [&>ul]:mb-1 [&>ol]:mb-1">
          {children}
        </li>
      ),
      ...
      a: ({ href, children }) => (
        <a
          ...
          className="text-black font-medium underline underline-offset-[3px] decoration-ash/50 hover:decoration-black transition-colors break-words"
        >
          {children}
        </a>
      ),
      ...
      code: ({ className: codeClass, children, ...props }) => {
        ...
        return (
          <code
            className="font-mono text-[12.5px] bg-light-ash/55 text-charcoal px-1.5 py-[2px] rounded-md break-words border border-ash/15"
            {...props}
          >
            {children}
          </code>
      ...
      td: ({ children }) => (
        <td className="px-3.5 py-2.5 align-top text-[13.5px] leading-relaxed break-words">
          {children}
        </td>
      ),
      input: ({ checked, ...props }) => (
  ...
  return (
    <div className={`alti-md max-w-[820px] w-full mx-auto ${className}`}>
