 ...
 *   - /altiq-logo-white.png — an optional light/white version, used
...
export default function Logo({ size = 32, showText = true, textClassName = '', className = '', variant = 'default' }) {
  ...
  const src = variant === 'light' ? '/altiq-logo-white.png' : '/altiq-logo.png';
      ...
      {!imgFailed ? (
        <img
          ...
          onError={(e) => {
            ...
            if (variant === 'light' && e.currentTarget.src.includes('altiq-logo-white')) {
