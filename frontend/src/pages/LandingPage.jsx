...
export default function LandingPage() {
  ...
  return (
    <div className="relative min-h-screen text-black overflow-x-hidden">
      ...
      {/* FOOTER — deliberately dark (very dark ash / near-charcoal) so it reads
          as a distinct closing band, not just more of the light page. Text and
          icons flip to light colors here since the background is dark. */}
      <footer className="relative z-10 py-14 px-5" style={{ backgroundColor: '#1C1C1C' }}>
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="flex items-center gap-3">
            <div className="w-7 h-7 rounded-full border border-white/30 flex items-center justify-center" aria-hidden="true">
              <div className="w-2.5 h-2.5 rounded-full bg-white/80" />
            </div>
            <span className="font-heading font-bold text-white">ALTIQ AI</span>
          </div>
