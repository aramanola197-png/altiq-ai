            ...
            <GlassCard key={m.opportunityId || m.opportunity?._id} className="p-6">
              <div className="flex flex-col sm:flex-row sm:justify-between gap-4">
                <div>
                  ...
                  {m.score != null && (
                    <p className="text-sm text-ash mt-1">Match score: {m.score}%</p>
                  )}
                  {m.estimatedReadiness != null && (
                    <p className="text-sm text-ash">Estimated readiness: {m.estimatedReadiness}%</p>
                  )}
                  ...
                  {m.suggestedImprovements?.length > 0 && (
                    <div className="mt-3">
                      <p className="text-xs text-ash uppercase tracking-wide mb-1">Suggested improvements</p>
        ...
        <GlassCard className="p-8">
          <div className="flex justify-between items-start mb-6 gap-4">
            <div>
              ...
              <p className="text-xs text-ash mt-1">{draft.note}</p>
            </div>
          </div>
