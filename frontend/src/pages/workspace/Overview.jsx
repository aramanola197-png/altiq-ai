      ...
      <GlassCard className="p-7">
        ...
        <div className="flex flex-wrap gap-3">
          <Link
            ...
            className="inline-block px-5 py-2.5 rounded-full bg-black text-black text-sm font-semibold hover:bg-charcoal transition"
          >
            Open AI Workspace
          </Link>
          <Link
