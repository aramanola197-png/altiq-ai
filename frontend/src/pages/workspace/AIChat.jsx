      ...
      <GlassCard className="p-5 sm:p-6 min-h-[280px] flex flex-col">
        ...
        <form onSubmit={handleSend} className="flex gap-3 items-end">
          <input
            ...
            disabled={sending}
            className="flex-1 px-4 py-3 rounded-full bg-page/50 border border-ash/30 text-sm outline-none focus:border-ash/50"
          />
          <button
            type="submit"
            disabled={sending || !input.trim()}
            className="px-5 py-3 rounded-full bg-black text-white text-sm font-semibold hover:bg-charcoal transition disabled:opacity-50"
          >
            Send
          </button>
        </form>
