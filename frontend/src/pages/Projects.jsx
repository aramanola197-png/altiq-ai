      ...
      <div className="max-w-5xl mx-auto px-5 py-10">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-12">
          <div>
            ...
            <p className="text-ash text-sm">Each project is an isolated workspace.</p>
          </div>
          <button
        ...
        {showForm && (
          <GlassCard className="p-8 mb-10">
            ...
            <form onSubmit={handleCreate} className="space-y-5">
              <div>
                <label className="block text-sm text-ash mb-2">Project name *</label>
                <input
                  required
                  value={name}
              ...
              <div>
                <label className="block text-sm text-ash mb-2">Short description</label>
                <textarea
                  value={description}
