...
export default function SignUp() {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center px-5 bg-page overflow-hidden">
      <OrbitalBackground intensity={0.45} />
      <div className="relative z-10 w-full max-w-md p-10" style={{ ...GLASS, ...CARD_RADIUS }}>
        <div className="text-center mb-10">
          ...
          <p className="text-dark-ash text-sm">Start building with ALTIQ AI</p>
        </div>

        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            <label className="block text-sm text-dark-ash mb-2">Name</label>
            <input
              type="text"
              value={name}
